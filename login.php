    ...
    <div class="tab-content">
       <div class="tab-pane container active" id="hospitals">
        <form action="file/hospitalLogin.php" method="post">
          ...
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Hastane Password</label>
          <input type="password" name="hpassword" placeholder="Hastane Password" class="form-control mb-4">
      ...
      <div class="tab-pane container fade" id="receivers">
         <form action="file/receiverLogin.php" method="post">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Alıcı E-postası</label>
          <input type="email" name="remail" placeholder="Alıcı Email" class="form-control mb-4">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Alıcı Password</label>
          <input type="password" name="rpassword" placeholder="Alıcı Password" class="form-control mb-4">
          <input type="submit" name="rlogin" value="Login" class="btn btn-primary btn-block mb-4">
        </form>
      </div>

    </div>
    <a href="register.php" class="text-center mb-4" title="Click here">Hesabın Yok mu?</a>
</div>
</div>
</div>
</div>
