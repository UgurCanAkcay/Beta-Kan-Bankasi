				...
				<div class="card">
					...
					<div class="card-body">
					   <form action="file/updateprofile.php" method="post">
					   	<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Alıcı Name</label>
						...
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Alıcı TelNo</label>
						...
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Alıcı Kan Grubu</label>
						...
						<input type="submit" name="update" class="btn btn-block btn-primary" value="Güncelleme">
					   </form>
					</div>
