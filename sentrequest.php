...
<!DOCTYPE html>
<html>
<?php $title="Kan Bankası & Blood Bank | Gönderilen İstekler"; ?>
...
<body>
	...
	<table class="table table-responsive table-striped rounded mb-5">
		<tr><th colspan="8" class="title">Gönderilen istekler</th></tr>
		<tr>
			<th>#</th>
			<th>İsim</th>
			<th>Email</th>
		    ...
		    <div>
                ...
                if ($result) {
                    ...
                    if ($row) { 
                }else echo '<b style="color:white;background-color:red;padding:7px;border-radius: 15px 50px;">Henüz talep etmediniz. </b>';
            }
            ?>
            </div>
